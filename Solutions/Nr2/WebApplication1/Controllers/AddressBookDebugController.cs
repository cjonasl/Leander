...
namespace AddressBook
{
    ...
    public static class RequestToApplicationUtility
    {
        ...
        public static void LogRequest(string prefix, NameValueCollection nameValueCollection)
        {
            try
            {
                ...
                {
                    SqlCommand com = new SqlCommand(string.Format("INSERT INTO RequestToApplication(ApplicationId, DateTimeUTC, RequestHeader) VALUES({0}, getutcdate(), '{1}')", AddressBookDebugController._applicationId.ToString(), str), conn);
                    conn.Open();
                    com.ExecuteNonQuery();
                }
            }
