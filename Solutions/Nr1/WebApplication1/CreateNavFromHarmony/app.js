/**
DLS Changes to default metronic js:
1. Changed search links to submit form rather than go to search_extra.html
2. Updated handlePortletTools to ensure that when you click on '.portlet .tools .expand' the grids inside the portlet are resized
**/

// IE fix (http://stackoverflow.com/questions/30867172/code-not-running-in-ie-11-works-fine-in-chrome)
...
var App = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar').on('keypress', '.sidebar-search input', function (e) {
            if (e.which == 13) {
                ...
                /** DLS - Changed line below to submit form **/
                //window.location.href = "extra_search.html";
                $('form.sidebar-search').submit();
        ...
        $('.sidebar-search .submit').on('click', function (e) {
            ...
            if ($('body').hasClass("page-sidebar-closed")) {
                if ($('.sidebar-search').hasClass('open') == false) {
                    ...
                    $(".sidebar-search [name=searchTerm]").focus();
                } else {
    ...
    var handlePortletTools = function () {
        ...
        // DLS: Commented this out and replaced in dls.navigation so we can attach to bars instead
        ...
        //        /** DLS - Changed line below to make sure grids inside portlet are resized on expand **/
        //        el.slideDown(200, function () {
        //            if (typeof GRIDUtils !== "undefined") {
        //                GRIDUtils.resizeGrids($(this).closest('.portlet'));
        //            }
        //        });
        //        // el.slideDown(200);
        //    }
    ...
    return {
        ...
        scrollTo: function (el, offeset) {
            pos = el ? el.offset() ? el.offset().top : 0 : 0;
            jQuery('html,body').animate({
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el);
            el.block({
                message: '<img src="/hijump/dls/img/ajax_animation.gif" align="">',
