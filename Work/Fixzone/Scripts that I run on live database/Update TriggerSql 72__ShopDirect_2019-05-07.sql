/*
  This was in script "Create Triggers table backup__ShopDirect_2019-05-03.sql", but "eev.MESSAGESRV_EMLBESV_HTML_EMAIL" was wrong. Must be "eev.MESSAGESRV_EMLBESLW_HTML_EMAIL"
  Ran ok 2019-05-07 kl. 12:58
*/
UPDATE [Triggers]
