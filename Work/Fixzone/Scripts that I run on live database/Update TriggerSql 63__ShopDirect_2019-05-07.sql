/*
  This was in script "Create Triggers table backup__ShopDirect_2019-05-03.sql", but "DiaryEnt.EventDate" was wrong. Must be "dia.EventDate"
  Ran ok 2019-05-07 kl. 10:29
*/
UPDATE [Triggers]
