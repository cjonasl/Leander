...
#region SET INFO
        ...
        public void SetBookingParameters(string modelNum, string descr, int softId, string repairFaq,string ItemCode,string ModelBrand,int RepairID)
        {
            var prod = _productStateHolder.Load();
