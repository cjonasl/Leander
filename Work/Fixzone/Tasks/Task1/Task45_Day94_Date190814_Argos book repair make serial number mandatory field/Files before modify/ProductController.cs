        ...
        public ActionResult ShowDetails()
        {
            if (_product.GetModelId() > 0)
            {
                ...
                if (model.IsCallCenter)
                    _product.SetBookingParameters(model.ModelNum, model.Description, model.SoftId, model.CCRepairFaq, model.ItemCode,model.ModelBrand);
                else
                    _product.SetBookingParameters(model.ModelNum, model.Description, model.SoftId, model.RepairFaq, model.ItemCode, model.ModelBrand);
