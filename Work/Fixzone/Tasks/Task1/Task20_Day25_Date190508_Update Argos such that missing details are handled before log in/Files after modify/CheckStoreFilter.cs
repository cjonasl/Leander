                    ...
                    if (action.Equals("Go"))
                    {
                        ...
                        if (Convert.ToInt32(id) != (int)PredefinedProcess.FirstTimeNewUser)
                        {
                            if (Convert.ToInt32(id) != (int)PredefinedProcess.SignIn)
                            {
                                ...
                                if (!(Convert.ToInt32(id) == Convert.ToInt32(PredefinedProcess.ForgottenPassword) || Convert.ToInt32(id) == Convert.ToInt32(PredefinedProcess.ProductSearch) || Convert.ToInt32(id) == Convert.ToInt32(PredefinedProcess.ExpiredPassword)))
