...
namespace ClientConnect.Home
{
    ...
    public enum BusinessRuleKey
    {
        ...
        CustomerPreviewPage_Title_Is_Editable,
        CustomerPreviewPage_Forename_Is_Editable,
        CustomerPreviewPage_Surname_Is_Editable,
        CustomerPreviewPage_Postcode_Is_Editable,
        CustomerPreviewPage_Addr1_Is_Editable,
        CustomerPreviewPage_Addr2_Is_Editable,
        CustomerPreviewPage_Addr3_Is_Editable,
        CustomerPreviewPage_Town_Is_Editable,
        CustomerPreviewPage_County_Is_Editable,
        CustomerPreviewPage_Country_Is_Editable,
        CustomerPreviewPage_Tel1_Is_Editable,
        CustomerPreviewPage_Tel2_Is_Editable,
        CustomerPreviewPage_Email_Is_Editable,
        CustomerPreviewPage_ContactMethod_Is_Editable
    }
