...
/****** Object:  StoredProcedure [dbo].[Retrieve_UserDetails]    Script Date: 19/08/2019 14:29:56 ******/
SET ANSI_NULLS ON
GO
...
select @N = COUNT(*) from UserWeb u left join Client c on c.ClientId = u.ClientID where UserId = @UserId

INSERT INTO AnalyzeLogIn(DateAndTime, UserId, N)
VALUES(getdate(), @UserId, @N)		
	...
	select 
		...
		c.ClientOnStopNotes  as 'ClientOnStopNotes' ,Cast(c.ClientBookingType as int) ClientBookingType
