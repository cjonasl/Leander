...
/****** Object:  StoredProcedure [dbo].[ProductList]    Script Date: 19/08/2019 14:22:22 ******/
SET ANSI_NULLS ON
GO
...
INSERT INTO AnalyzeProductSearch(DateAndTime, Criteria, ReturnLines, PageNumber, Clientid)
VALUES(getdate(), @Criteria, @ReturnLines, @PageNumber, @Clientid)
	...
	begin
	 ...
	 -- left outer join supplier on supplier.supplierid=m1.supplierid
	  join (
		...
		join ClientModel CM on 	cm.modelid=m1.MODELID  and cm.ClientID=@Clientid
