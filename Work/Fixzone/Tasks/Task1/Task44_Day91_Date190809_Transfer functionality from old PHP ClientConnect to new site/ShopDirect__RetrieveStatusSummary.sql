...
--Added the joins to avoid the count mismatch between the count and the list of jobs - Mary 19/12/2018
...
Where S.ClientID=@StoreId 	 
and s.STATUSID=12  and s.SUBSTATUS not in (5,6,3,4) 
