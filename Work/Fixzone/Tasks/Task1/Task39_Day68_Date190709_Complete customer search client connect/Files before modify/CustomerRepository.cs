...
namespace ClientConnect.Repositories
{
    public class CustomerRepository : Repository
    {
        ...
        internal int SaveCustomerBackup(CustomerModel customer, string UserId, int StoreId)
        {
            ...
            public List<Customer_SearchResult> GetCustomers(string searchCriteria, int pageNumber, int pageSize, int StoreId)
        {
            ...
            internal List<Customer_SearchResult> GetCustomers(string Surname, string Postcode, string TelNo, string PolicyNumber, string ClientCustRef, string Address, int pageNumber, int pageSize, int StoreId)
            {
                return Query<Customer_SearchResult>("SearchCustomers", new
                {
                    //Surname = customerSearch.surname,
                    //address = customerSearch.address,
                    //policynumber = customerSearch.policynumber,
                    //PostCode = customerSearch.postcode,
                    //Tel = customerSearch.tel1,
                    //custClientref = customerSearch.custClientref,
