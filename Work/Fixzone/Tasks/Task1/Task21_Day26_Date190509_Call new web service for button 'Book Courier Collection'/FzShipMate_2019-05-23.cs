...
namespace Mobile.Portal.BLL.FzShipMate
{
    ...
    public class FzShipMate
    {
        ...
        public string GetUrl(FzShipMateAction fzShipMateAction, string trackingReference = null, string consignmentReference = null)
        {
        ...
        {
            return MakeWebRequest<ConsignmentResponse>(GetUrl(FzShipMateAction.CreateConsignment), consignmentRequest.ToJson());
        }
