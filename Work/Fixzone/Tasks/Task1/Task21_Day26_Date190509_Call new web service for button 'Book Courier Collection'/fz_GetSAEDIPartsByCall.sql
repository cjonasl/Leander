...
/****** Object:  StoredProcedure [dbo].[fz_GetSAEDIPartsByCall]    Script Date: 10/05/2019 13:37:12 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
  SELECT DISTINCT
	...
	P.[TransactionCode],	
	P.[OrderReference],	  	
	(case p.CodeID when '000000010' then SSRMA.RmaId else ISNULL(P.[ReturnReference], '') end)
	as [ReturnReference],
	P.[ReturnRequired],
	P.[ReturnDescription],
	P.[DeliveryNumber],
