 select 
  hist.Userid as MESSAGESRV_EmlCustLWP_HTML_EMAIL, 
  hist._id ,
  hist.Created,
...
LEFT JOIN TriggerRes ON TRIGGERID=7 AND TRIGGERFIELDLAST='_id' AND TriggerRes.TriggerValue=hist._id
...
AND Cs.EMAIL=hist.Userid AND Cs.RetailClientID=1
