SELECT 
  ...
  --'07472939499' 
  AS MESSAGESRV_CONFBKV_TEXT_SMS,  
...
(Customer.RetailClientID=2 AND (Customer.TEL1 LIKE '07%' OR  Customer.TEL2 LIKE '07%' OR Customer.TEL3 LIKE '07%')) AND POP_Apl.MONITORFG='F' AND Enginrs.DumpDiary=0) 
