SELECT 
Customer.EMAIL
   AS MESSAGESRV_COURV_HTML_EMAIL,  
...
(Customer.RetailClientID=2 AND Customer.EMAIL IS NOT NULL) AND POP_Apl.MONITORFG='T'
 AND Enginrs.DumpDiary=0 and  (SpecJobMapping.DummyJob <> 1   or SpecJobMapping.DummyJob is  null) 
)