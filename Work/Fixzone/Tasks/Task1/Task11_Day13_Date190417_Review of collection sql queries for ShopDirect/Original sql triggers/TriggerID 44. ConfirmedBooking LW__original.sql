...
top 25 
 Customer.EMAIL
     AS MESSAGESRV_CONFBKLW_HTML_EMAIL,  
...
WHERE (DiaryEnt.EventDate > GETDATE()  AND (Customer.RetailClientID=1 AND Customer.EMAIL IS NOT NULL) AND POP_Apl.MONITORFG='F' AND Enginrs.DumpDiary=0)  
