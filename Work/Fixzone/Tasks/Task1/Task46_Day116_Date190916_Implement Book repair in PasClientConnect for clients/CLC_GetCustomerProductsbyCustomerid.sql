...
/****** Object:  StoredProcedure [dbo].[CLC_GetCustomerProductsbyCustomerid]    Script Date: 18/09/2019 11:18:13 ******/
SET ANSI_NULLS ON
GO
...
AS
 ...
 from 
	...
	WHERE 
(ISNULL(ca.model, '') <> 'DPAFAIL' and ISNULL(ca.APPLIANCECD, '') <>'DPAF') and
