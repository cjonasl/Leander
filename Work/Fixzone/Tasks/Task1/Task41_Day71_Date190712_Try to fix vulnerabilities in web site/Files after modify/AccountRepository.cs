...
namespace CAST.Repositories
{
    public class AccountRepository : Repository
    {
        ...
        {
            return Query<CustomerAccount>("Retrieve_CustomerAccountDetailsByEmail", new { Email = email, RetailClientId = retailClientId }, commandType: CommandType.StoredProcedure)
               .ToList();
