...
namespace ClientConnect.Infrastructure
{
    public static class ClientBusinessRule
    {
        ...
        public static void GetVisibility(HttpSessionState session, out bool productSearchIsVisible, out bool jobSearchIsVisible, out bool customerSearchIsVisible, out bool jobStatusesIsVisible, out int clientId, out bool isAdm, out string cols)
        {
            int n;
