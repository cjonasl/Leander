...
def Sudoku.run(index, sudokuArray)
    ...
    return print_result(index, sudokuArray, sudoku_solved, number_of_cells_set_in_input_sudoku_board, number_of_cells_set_in_best_so_far, working_sudoku_board, best_so_far_sudoku_board)
end
...
def Sudoku.get_input_sudoku_board(sudoku_board, cells_remain_to_set, index, sudokuArray)

    sudoku_board_string = sudokuArray[index].gsub("\r\n", "\n")
...
def Sudoku.print_result(index, sudokuArray, sudoku_solved, number_of_cells_set_in_input_sudoku_board, number_of_cells_set_in_best_so_far, working_sudoku_board, best_so_far_sudoku_board)
    if sudoku_solved
        msg = "S"
    else
